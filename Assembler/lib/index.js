...
var Parse = require("./parser"),
    ...
    Util = require("stackvm-util");

// Constructor
var StackVm = module.exports = {};
 ...
 */
StackVm.compile = function (lines) {
    var result = {
        raw: [],
        mCode: []
    };
    ...
    parsed.lines.forEach(function (c, i) {
        ...
        var ins = StackVm.compileLine(c, parsed);
        if (!ins.length) {
            return;
        }
        result.raw.push({
